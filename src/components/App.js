        ...
        return (
            <div>
                ...
                <div className="row fixed-bottom">
                    <div className="col-sm-12 btn-group" role="group" aria-label="Basic example">
                        <button type="button" class="btn btn-secondary w-100 navigation">
                        ...
                        <button type="button" class="btn btn-secondary w-100 navigation navigationDivider">
