...
//() CHANGE 3D WORLDS ONCE POMODORO REACHES CERTAIN NUMBER
//() INCREASE FAR CLIP SIZE ON CAMERA ONCE CAMERA SHOWS SKYBOX
//(DONE) CREATE NEW BACKGROUND SCENERY
//() CHECK IF SLOW PET SIZE INCREASE INSTEAD OF CLOUD ANIM LOOKS BETTER
